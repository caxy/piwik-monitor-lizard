 ...
 */
class GetEventsbyUser extends Base
{
    protected function init()
    {
        parent::init();

        $this->name          = Piwik::translate('MonitorLizard_EventsbyUser');
        ...
        // $this->menuTitle    = 'MonitorLizard_EventsbyUser';
        ...
        // $this->widgetTitle  = 'MonitorLizard_EventsbyUser';
    }
    ...
    {
        $view = new View('@MonitorLizard/getEventsbyUser');
        $view->myData = array();
